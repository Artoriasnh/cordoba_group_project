...
public class ChatInterface extends JFrame implements ActionListener {
	...
	public void buildInterface() {
		...
		// just a test
		// could populate window with all users, 
		// double clicking on a user label would check the SocketList,
		// adding them to the conversation or giving a warning.
		...
		public void run() {
			while (true) {
				...
				if ("connectionRequest".equals(msg.getCmd())) {
					...
					System.out.print(msg.getData().toString());
